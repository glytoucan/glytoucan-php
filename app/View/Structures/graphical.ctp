...
callBack.run=function(response){
  ...
  var url = "/Structures/graphical?input01=exact&select1=glycoCT_condensed&text1=";
...
<div class="text-error">
	<?php echo $this->Session->flash(); ?>
      ...
      <form id="frm1" name="frm1" action="ms" method="GET" class="form-search">
        <input type="button" name="Search" value="<?php echo $common_doc['search'] ?>" onclick='exportCanvas("glycoct_condensed","callBack");'/>
      </form>
